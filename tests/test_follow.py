...
class TestFollow:
    ...
    def test_follow_auth(self, user_client, user, post):
        ...
        user_1 = get_user_model().objects.create_user(username='TestUser_2344', avatar=image)
        user_2 = get_user_model().objects.create_user(username='TestUser_73485', avatar=image)
